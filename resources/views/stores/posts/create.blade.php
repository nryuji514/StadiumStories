...
<html lang="{{ str_replace('_','-', app()->getLocale()) }}">
    ...
    <x-app-layout>
        <h1>Blog Name</h1>
        <form action="{{ route('stores.posts.store', ['store' => $store->id]) }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="body">
                <h2>Body</h2>
                <textarea name="body" placeholder="今日も一日お疲れさまでした。">{{ old('body') }}</textarea>
